...
`
        ...
        if (cardCondition == "about") {
            card = `
            <div class="about">
            <img src="./assets/photos/profile-photo.jpeg" class="profile-photo" alt="">
            <p>
            Hi!, my name is Ben, <br> and i am an aspiring full stack developer,
            currently studying at John Bryce in Tel Aviv, while working with multiple coding tools,
            such as - js and jQuery, thank you for watching my site, and if you want to get in touch,
            feel free to reach out to me.
            </p>
            <a href="https://www.linkedin.com/in/ben-spector-370394164/"><img src="./assets/photos/download.png" width="40" alt=""></a>
